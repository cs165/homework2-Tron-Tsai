...
var images = document.querySelectorAll('.flexitem');
const boxes = document.querySelectorAll('.flexitem > .checkbox');
var answer = [0,0,0];
var totalans = [0,0,0];
var finalans = 0;
console.log(images);
...
console.log(boxes);
console.log(images[0].dataset.choiceId);
console.log(images[0].dataset.questionId);
...
function select(event) {
    ...
    console.log(image);
    console.log(image.dataset.questionId);
    if(image.dataset.questionId=="one")
    {
        var otherimages =  document.querySelectorAll('[data-question-id="one"]');
        answer[0] = 1;
        totalans[0] = image.dataset.choiceId;
    }
    if(image.dataset.questionId=="two")
    {
        var otherimages =  document.querySelectorAll('[data-question-id="two"]');
        answer[1]=1;
        totalans[1] = image.dataset.choiceId;
    }
    if(image.dataset.questionId=="three")
    {
        var otherimages =  document.querySelectorAll('[data-question-id="three"]');
        answer[2]=1;
        totalans[2] = image.dataset.choiceId;
    }
    console.log(otherimages);
    for(var otherimage of otherimages){
        otherimage.classList.remove('flexitem-check');
        otherimage.classList.add('flexitem-nocheck');
    }
    image.classList.remove('flexitem-nocheck');
    image.classList.add('flexitem-check');
    console.log(otherimages[0].dataset.questionId);
    console.log(otherimages[0].classList);
